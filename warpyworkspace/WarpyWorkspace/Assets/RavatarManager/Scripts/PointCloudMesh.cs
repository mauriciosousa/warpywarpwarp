        ...
        try
        {
           //Body b = GameObject.Find("BodiesManager").GetComponent<BodiesManager>().human.body;
            ...
            for (int i = 0; i < renderers.Length; i++)
            {
                ...
                mr.material.SetVector("leftShoulder", b.leftShoulder.position);
                mr.material.SetVector("leftElbow", b.leftElbow.position);
                mr.material.SetVector("leftWrist", b.leftWrist.position);
                mr.material.SetVector("leftHand",       b.leftHand.position);
                mr.material.SetVector("leftThumb",      b.leftThumb.position);
                mr.material.SetVector("leftHandTip",    b.leftHandTip.position);
                ...
                mr.material.SetVector("rightShoulder",  b.rightShoulder.position);
                mr.material.SetVector("rightElbow",     b.rightElbow.position);
                mr.material.SetVector("rightWrist",     b.rightWrist.position);
                mr.material.SetVector("rightHand",      b.rightHand.position);
                mr.material.SetVector("rightThumb",     b.rightThumb.position);
                mr.material.SetVector("rightHandTip",   b.rightHandTip.position);
